  ...
  return (
    <section id="frameworks" className="stepped-top bg-stacks-orange pt-8 lg:pt-10">
      <div className="mx-auto max-w-7xl px-6 pb-16 pt-12 lg:px-8 lg:pb-20 lg:pt-16">
        <h2 className="text-3xl font-semibold text-white lg:text-4xl">Ways to get started</h2>
        ...
        <div className="mt-10 grid overflow-hidden rounded-2xl border border-white/20 md:grid-cols-2 xl:grid-cols-4">
          {FRAMEWORKS.map((framework, index) => (
            <FrameworkCard
              ...
              docsHref={framework.docsPath ? docsUrl(framework.docsPath) : undefined}
              ...
              underDevelopment={framework.underDevelopment}
