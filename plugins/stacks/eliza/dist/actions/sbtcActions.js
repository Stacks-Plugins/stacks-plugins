...
exports.sbtcActions = void 0;
const agent_core_1 = require("@sugarhi11/agent-core");
const shared_1 = require("../shared");
exports.sbtcActions = [
    (0, shared_1.makeAction)({
        name: 'stacks_sbtc_get_balance',
        description: 'Get sBTC balance for a Stacks address. Use when the user asks about sBTC holdings. ' +
        ...
        handler: agent_core_1.sbtcGetBalance,
        examples: [
            [
    ...
    (0, shared_1.makeAction)({
        ...
        description: 'Transfer sBTC on Stacks (SIP-010). Recipient must differ from sender (no self-transfers). Confirm recipient and amount before sending. ' +
    ...
    (0, shared_1.makeAction)({
        ...
        description: 'Build an sBTC peg-in deposit address (BTC to sBTC) without broadcasting Bitcoin. ' +
        ...
        handler: agent_core_1.sbtcBuildPegIn,
        examples: [
            [
    ...
    (0, shared_1.makeAction)({
        ...
        description: 'Peg BTC into sBTC: signs and broadcasts a Bitcoin deposit tx and notifies Emily. ' +
        ...
        handler: agent_core_1.sbtcInitiatePegIn,
        examples: [
            [
    ...
    (0, shared_1.makeAction)({
        ...
        description: 'Initiate sBTC peg-out (withdraw sBTC for BTC on Bitcoin L1). Async; poll status afterward. ' +
            'Params: { amount, bitcoinRecipient, maxFee?, network? }. senderKey auto-injected.',
        similes: ['PEG_OUT_SBTC', 'WITHDRAW_SBTC', 'SBTC_TO_BTC'],
        handler: agent_core_1.sbtcInitiatePegOut,
        signed: true,
        examples: [
            [
    ...
    (0, shared_1.makeAction)({
        ...
        handler: agent_core_1.sbtcGetPegStatus,
        examples: [
            [
