...
export const STACKS_TOOLS = [
  ...
  },
  {
    ...
    description:
      'Transfer sBTC on Stacks via the sbtc-token SIP-010 contract. Recipient must differ from sender (self-transfers fail post-conditions).',
    handler: sendSbtc,
    write: true,
  },
  {
    ...
    description:
      'Build an sBTC peg-in deposit address and scripts without broadcasting Bitcoin.',
  ...
  },
  {
    ...
    description:
      'Peg BTC into sBTC: sign and broadcast a Bitcoin deposit tx and notify Emily. Requires BITCOIN_PRIVATE_KEY and BITCOIN_ADDRESS.',
  ...
  },
  {
    ...
    description:
      'Initiate sBTC peg-out (withdraw sBTC for BTC). Locks sBTC and creates a withdrawal request.',
