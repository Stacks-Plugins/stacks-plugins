...
export const stacksToolSpecs: ToolSpec[] = [
  {
    name: 'stacks_get_balance',
    description:
      'Look up STX and token balances on Stacks. Use when the user asks about balance, ' +
  ...
  },
  {
    ...
    description:
      'Send STX to another Stacks address. Use when the user wants to transfer, send, or pay STX. ' +
  ...
  },
  {
    ...
    description:
      'Fetch recent transactions for a Stacks address. Use when the user asks for history, ' +
  ...
  },
  {
    ...
    description:
      'Revoke an active stacking delegation. senderKey is auto-injected. Params: { network? }.',
    parameters: Type.Object({
      fee: Type.Optional(Amount),
      nonce: Type.Optional(Amount),
      network: Network,
  ...
  },
  {
    ...
    description:
      'Transfer sBTC on Stacks via sbtc-token SIP-010. Recipient must differ from sender (no self-transfers). Confirm recipient and amount. senderKey auto-injected. ' +
  ...
  },
  {
    ...
    description:
      'Build sBTC peg-in deposit address and scripts without broadcasting Bitcoin. ' +
  ...
  },
  {
    ...
    description:
      'Peg BTC into sBTC: broadcast Bitcoin deposit and notify Emily. Requires BITCOIN_PRIVATE_KEY and BITCOIN_ADDRESS. ' +
  ...
  },
  {
    ...
    description:
      'Initiate sBTC peg-out (withdraw sBTC for BTC). senderKey auto-injected. ' +
  ...
  },
  {
    ...
    description:
      'Supply sBTC to Zest vault-sbtc for yield (receive zsBTC). Check pause state first. senderKey auto-injected. ' +
  ...
  },
  {
    ...
    description:
      'Redeem zsBTC shares from Zest vault-sbtc. senderKey auto-injected. ' +
  ...
  },
  {
    ...
    description:
      'Read Zest market position (collateral and debt) for a Stacks address. Params: { address?, network? }.',
    parameters: Type.Object({
      address: Type.Optional(Type.String()),
      network: Network,
    }),
  ...
  },
  {
    ...
    description:
      'Post sBTC as Zest market collateral. senderKey auto-injected. ' +
  ...
  },
  {
    ...
    description:
      'Borrow from Zest market against collateral. senderKey auto-injected. ' +
  ...
  },
  {
    ...
    description:
      'Repay Zest market debt. senderKey auto-injected. ' +
